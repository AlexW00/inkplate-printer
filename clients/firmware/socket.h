...
// To interact with the socket, use socket_controller.h

#define USE_SERIAL Serial

SocketIOclient socketIO;

void _on_socket_event(socketIOmessageType_t type, uint8_t *payload, size_t length) {
  switch (type) {
...
void _socket_setup() {
  ...
  socketIO.onEvent(_on_socket_event);
}
